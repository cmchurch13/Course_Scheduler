...
public class CourseNodeManager {
    ...
    private JPanel SchedTreePanel = new JPanel();   //Grid Panel that holds individual classes that are apart of the indicated program
    private JPanel ElectivesPanel = new JPanel();   //Grid Panel that holds Electives courses.
    private checkTaken takenLstnr = new checkTaken();
    private courseResizeAdapter resizer = new courseResizeAdapter();
     ...
     * @param tree 
     */
    public void TreeCreation(Course[] CL, JPanel tree){    
